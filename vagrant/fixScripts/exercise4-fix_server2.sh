...
sudo su - vagrant -c "ssh-keygen -t rsa -N '' -f /home/vagrant/bob2"
sudo su - vagrant -c "sudo  chmod 755 /home/vagrant/.shh && chmod 644 /home/vagrant/.shh/authorized.keys"
...
sudo su - vagrant -c "sshpass -p vagrant  ssh-copy-id -i /home/vagrant/.ssh/bob2.pub server1 "
