...
sudo mv /vagrant/keys2 /home/vagrant/.ssh/keys2   
sudo cat /vagrant/keys1.pub |sudo tee -a /home/vagrant/.ssh/authorized_keys 
sudo mv /vagrant/keys2.pub /home/vagrant/.ssh/keys2.pub 
